...
///==================================================================================================
//Current Version 3: Right now the front motor will pull up the leg, while it's doing to the rear 
// motor will release the cable simultaneously, but after that the front motor releases the leg, and
// the rear cable tighten up!
///==================================================================================================
...
//flex=only=backwards=======
void knee_flex(int distance, uint8_t motor_direction_f, uint8_t motor_direct_b){
  Serial.println("Flexing knee backwards");
  increase_motor_speed(3, motor_direction_f,HAMSTRING_MOTOR,100);
  delay(distance*fact);
...
//    delay(10);  // need to make both run at the same time
 ...
 //2 Start by raising hip forward
    hip_flex(4500, 1, FORWARD, BACKWARD,100);  //pull front cable  (distance, motor number, f_motor_direction, b_motor_direct, speed)
    delay(10);
 //3 move hip back into position   
    hip_flex(3000, 1, BACKWARD, FORWARD,100); //release front cable


// 4  hip_flex_b(7000, 2, FORWARD,255);//rear cable tigten
//    delay(10);  // need to make both run at the same time
