...
void setup() {
  ...
  mySerial.begin(9600);
  mySerial.println("Sending packets from IMU");
...
void loop() {
  ...
  mySerial.println("Hello from IMU");
  // Serial.write(mySerial.read()); // read from dw1000
  delay(100);
  // if (mySerial.available()) { // reads from hardware sends to software
  //   Serial.write(mySerial.read()); // read from dw1000
  //   Serial.println("ntered!");
  // }
  // if (Serial.available()) { // reads from software sends to hardware
